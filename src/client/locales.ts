...
export const zh = {
  ...
  'dependency.showCompleted': '显示已完成任务',
  'dependency.showCompletedHint': '默认隐藏已完成/已终止任务，只显示进行中及与其相关的任务',
...
export const en = {
  ...
  'dependency.showCompleted': 'Show completed',
  'dependency.showCompletedHint': 'Hidden by default: also show completed/cancelled tasks (keeps in-progress + their deps visible)',
